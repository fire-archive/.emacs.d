...
+srcname: disable-fullscreen-settings
...
+srcname: google-c-style-settings
+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (setq TeX-view-program-list
    ...
    ;; (setq-default TeX-master nil)
      ...
      (shell-command "osacript -e 'tell application \"Emacs\" to activate' &"))
