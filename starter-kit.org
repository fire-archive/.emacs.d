...
*** Starter kit Elixir
Located in [[file:starter-kit-js.org][starter-kit-elixir]]

#+begin_src emacs-lisp
(starter-kit-load "starter-kit-elixir.org")
#+end_src
*** Starter kit JS
...
*** Starter kit Qml
Located in [[file:starter-kit-js.org][starter-kit-qml]]

#+begin_src emacs-lisp
(starter-kit-load "starter-kit-qml.org")
#+end_src
...
#+end_src
*** Starter Kit JVM Language
Located in [[file:starter-kit-stats.org][starter-kit-jvm]]

#+begin_src emacs-lisp
  (starter-kit-load "starter-kit-jvm.org")
#+end_src
...
#+end_src
*** Starter Kit C#
Located in starter-kit-csharp
#+begin_src emacs-lisp
  (starter-kit-load "starter-kit-csharp.org")
#+end_src
